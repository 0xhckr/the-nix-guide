...
description: Getting started with nix
---

Nix, like we discussed in the introduction, could mean a lot of things. This guide covers only NixOS, nix-darwin (though I don't actively use this myself anymore), and the nix language itself for usage in various projects.
